...
function createLevel1() {
    return new Level(
        ...
        [
            ...
            new BackgroundObject('assets/images/backgrounds/layers/air.png', 2880),
            new BackgroundObject('assets/images/backgrounds/layers/3_third_layer/1.png', 2880),
            new BackgroundObject('assets/images/backgrounds/layers/2_second_layer/1.png', 2880),
            new BackgroundObject('assets/images/backgrounds/layers/1_first_layer/1.png', 2880),

            new BackgroundObject('assets/images/backgrounds/layers/air.png', 3600),
            new BackgroundObject('assets/images/backgrounds/layers/3_third_layer/2.png', 3600),
            new BackgroundObject('assets/images/backgrounds/layers/2_second_layer/2.png', 3600),
            new BackgroundObject('assets/images/backgrounds/layers/1_first_layer/2.png', 3600),

            new BackgroundObject('assets/images/backgrounds/layers/air.png', 4320),
            new BackgroundObject('assets/images/backgrounds/layers/3_third_layer/1.png', 4320),
            new BackgroundObject('assets/images/backgrounds/layers/2_second_layer/1.png', 4320),
            new BackgroundObject('assets/images/backgrounds/layers/1_first_layer/1.png', 4320),
